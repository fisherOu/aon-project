...
contract Movev2System is System {
    ...
    function executeTyped(
        ...
        MoveCooldownComponent moveCooldown = MoveCooldownComponent(
        ...
        MoveCooldown movable = moveCooldown.getValue(entity);
        require(
            movable.remainingMovePoints > 0 ||
                now - movable.lastMoveTime > moveConfig.increaseCooldown,
            "no move points"
        );
