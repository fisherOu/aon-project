...
uint get_total_signal_no() {return 2001;}

uint get_number_of_components() {return 17;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 1516;}
...
// load src
Fr_add(&expaux[0],&circuitConstants[5],&signalValues[mySignalStart + 0]); // line circom 16
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&circuitConstants[5],&signalValues[mySignalStart + 0]); // line circom 21
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[1]); // line circom 22
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 4]); // line circom 34
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 5]); // line circom 35
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 3]); // line circom 36
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[2]); // line circom 39
